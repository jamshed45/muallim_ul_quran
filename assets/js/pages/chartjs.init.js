...
!function ($) {
  ...
  ChartJs.prototype.init = function () {
    ...
    var pieChart = {
      ...
      datasets: [{
        data: [300, 180],
        backgroundColor: ["#31A1B1", "#ebeff2"],
        hoverBackgroundColor: ["#31A1B1", "#ebeff2"],
        hoverBorderColor: "#fff"
      }]
    };
    ...
    var barChart = {
      ...
      datasets: [{
        label: "Sales Analytics",
        backgroundColor: "#31A1B1",
        borderColor: "#31A1B1",
        borderWidth: 1,
        hoverBackgroundColor: "#31A1B1",
        hoverBorderColor: "#31A1B1",
    ...
    var radarChart = {
      ...
      datasets: [{
        ...
        borderColor: "#31A1B1",
        pointBackgroundColor: "#31A1B1",
        pointBorderColor: "#fff",
        pointHoverBackgroundColor: "#fff",
        pointHoverBorderColor: "#31A1B1",
    ...
    var polarChart = {
      datasets: [{
        data: [11, 16, 7, 18],
        backgroundColor: ["#38a4f8", "#31A1B1", "#ec4561", "#3c4ccf"],
        label: 'My dataset',
        // for legend
        hoverBorderColor: "#fff"
      }],
