...
@section('body') <body data-sidebar="dark"> @endsection
    ...
    @slot('page_title') Form Elements @endslot
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="color" class="form-control form-control-color w-100" id="example-color-input" value="#31A1B1" title="Choose your color">
                        </div>
                    </div>
                    <!-- end row -->
                    <div class="row mb-3">
