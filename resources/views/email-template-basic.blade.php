...
@section('title') Basic Action Email @endsection
@section('css')
...
@section('body') <body data-sidebar="dark"> @endsection
    ...
    @slot('page_title') Basic Email @endslot
    @slot('subtitle') Email Templates @endslot
    @endcomponent
