...
@section('title') All Skip Appointments @endsection
@section('css')
<!-- DataTables -->
...
@section('body') <body data-sidebar="dark"> @endsection
    ...
    @slot('page_title') All Skip Appointments @endslot
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-9"><h4 class="card-title">All Skip Appointments</h4></div>
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                        ...
                        <tbody>
                            @if(!empty($skipappointmentGhl))

                            @foreach($skipappointmentGhl as $val)
                            <tr>
                                ...
                                <td>
                                  ...
                                  <td>
                                    @if(auth()->check() && (auth()->user()->hasRole('Super Admin') || auth()->user()->can('Skip Appointments D-Flo Merge Data')))
