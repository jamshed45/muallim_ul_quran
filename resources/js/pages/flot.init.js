  ...
  FlotChart.prototype.createDonutGraph = function(selector, labels, datas, colors) {
    ...
    tooltipOpts : {
      ...
      FlotChart.prototype.init = function() {
        ...
        var pcolors = ['#f0f1f4', '#3c4ccf', '#31A1B1'];
        ...
        var datas = [20,30, 15];
        var colors = ['#3c4ccf','#31A1B1', "#ebeff2"];
        this.createPieGraph("#pie-chart #pie-chart-container", pielabels , datas, colors);


          //real time data representation
          var plot = this.createRealTimeGraph('#flotRealTime', this.randomData() , ['#31A1B1']);
          plot.draw();
          var $this = this;
          function updatePlot() {
        ...
        var donutcolors = ['#f0f1f4', '#3c4ccf', '#31A1B1'];
